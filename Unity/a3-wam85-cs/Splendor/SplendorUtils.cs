...
namespace Splendor
{
    ...
    public class AgentTrace
    {
        ...
        public List<Tuple<Action, int>> ActionReward { get; set; }

        public AgentTrace(int id)
        {
            Id = id;
            ActionReward = new List<Tuple<Action, int>>();
        }
        ...
        public AgentTrace DeepCopy()
        {
            ...
            {
                newTrace.ActionReward.Add(new Tuple<Action, int>(actionReward.Item1.DeepCopy(), actionReward.Item2));
            }
            return newTrace;
        }
    }
    ...
    // 工具类
    public static class SplendorUtils
    {
        ...
        // 将行动转换为字符串
        public static string ActionToString(int agentId, Action action)
        {
        ...
        // 将代理状态转换为字符串
        public static string AgentToString(int agentId, SplendorState.AgentState agentState)
        {
            return $"Agent #{agentId} has scored {agentState.Score} points thus far.\n";
        }

        // 将棋盘状态转换为字符串
        public static string BoardToString(SplendorState gameState)
        {
            return "";
        }
    }
